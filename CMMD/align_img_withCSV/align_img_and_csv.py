...
image_folder_path = r"E:\IAAA_CMMD\manifest-1616439774456\CMMD"
# Path to the CSV file containing the IDs
met_csv = r"E:/IAAA_CMMD/manifest-1616439774456/train.csv"
# Path to the CSV file to write the new file names to
output_csv_path = r"E:/IAAA_CMMD/manifest-1616439774456/CMMD_all_meta/cmmd_all_meta.csv"
destination_folder = r'E:/IAAA_CMMD/manifest-1616439774456/CMMD_all'
...
df1 = pd.read_csv(r"E:/IAAA_CMMD/manifest-1616439774456/train.csv")
# Path to the CSV file to write the new file names to
df2 = pd.read_csv(r"E:/IAAA_CMMD/manifest-1616439774456/CMMD_all_meta/cmmd_all_meta.csv")

           
new = pd.merge(df1, df2, how="inner", on=["ID1"])
new.to_csv(r"E:/IAAA_CMMD/manifest-1616439774456/CMMD_all_meta/cmmd_all_merg.csv")
